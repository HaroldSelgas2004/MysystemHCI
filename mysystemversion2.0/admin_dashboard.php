...
// Count totals filtered by this admin's user_id
...
$stmt = $conn->prepare("SELECT COUNT(*) FROM staffs WHERE added_by = ?");
$stmt->bind_param("i", $user_id);
$stmt->execute();
...
<style>
  ...
  .sidebar {
    background: white;
    width: 260px;
    box-shadow: 2px 0 6px rgba(249, 45, 45, 0.1);
    display: flex;
...
<div class="sidebar">
  ...
  <div class="menu">
    ...
    <div class="menu-item" onclick="toggleSubmenu('staffSubmenu')">StaffManage</div>
    <div class="submenu" id="staffSubmenu">
      <div class="submenu-item" onclick="location.href='staff_add.php'">Search Staff</div>
      <div class="submenu-item" onclick="location.href='staff_list.php'">Staff List</div>
    </div>
...
<div class="dashboard-content">
  ...
  <div class="dashboard-cards">
    ...
    <div class="card" onclick="location.href='staff_list.php'">
      <h3><?= $staff_count ?></h3>
      <p>Staff</p>
    </div>
